...
#ifndef __AM335XI2C_H__
#define __AM335XI2C_H__

//I2C register definitions.
#define I2C1BASE        0x44E0B000//

#define I2C_IE          (I2C1BASE + 0x2C)//
#define XRDY_IE         BIT4
#define RRDY_IE         BIT3
#define ARDY_IE         BIT2
#define NACK_IE         BIT1

#define I2C_STAT        (I2C1BASE + 0x28)//
#define BB              BIT12
#define XRDY            BIT4
#define RRDY            BIT3
#define ARDY            BIT2
